...
Vertical scroll narrative with stacked full-width sections, large editorial numbers marking each service pillar, generous negative space — Condensed grotesque display type paired with thin monospaced captions — Slate black (#18202B) + antique linen (#EDE6D6) + muted sage (#8A9E8C) + soft pewter (#9AA0A6) — Architectural calm; understated precision that earns rather than announces its authority
